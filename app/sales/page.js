    ...
    <div className="">
      ...
      <div className="page-header">
        <h1 className="page-title">
          <span className="subpage-title">Welcome To</span> Sales Dashboard
        </h1>
      ...
      {/* Row */}
      <div className="row">
        <div className="col-xl-3 col-lg-6 col-md-12 col-sm-6">
          <div className="card">
            <div className="card-body">
              <div className="d-flex">
                <div className="">
                  <div className="feature">
                    <div className="icon-service2 bg-primary br-3">
                      <i className="fe fe-users text-white fs-30" />
                    </div>
                  </div>
                </div>
                <div className="ml-auto text-right">
                  <p className="text-muted mb-1">Total Customers</p>
                  <h2 className="mt-2 mb-0 number-font">56,897</h2>
                </div>
              </div>
            </div>
            <div className="card-footer">
              <div className="float-left">
                <p className="mb-0">
                  <span className="">
                    <i className="fa fa-arrow-circle-o-down ml-1 text-danger" />{" "}
                    0.78%
                  </span>{" "}
                  last week
                </p>
              ...
              <div className="float-right">
                <i className="fa fa-line-chart text-muted" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex">
                <div className="">
                  <div className="feature">
                    <div className="icon-service2  bg-secondary br-3">
                      <i className="fe fe-bar-chart-2 text-white fs-30" />
                    </div>
                  </div>
                </div>
                <div className="ml-auto text-right">
                  <p className="text-muted mb-1">Total Sales</p>
                  <h2 className="mt-2 mb-0 number-font">78,962</h2>
                </div>
              </div>
            </div>
            <div className="card-footer">
              <div className="float-left">
                <p className="mb-0">
                  <span className="">
                    <i className="fa fa-arrow-circle-o-up ml-1 text-success" />{" "}
                    1.5%
                  </span>{" "}
                  last week
                </p>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex">
                <div className="">
                  <div className="feature">
                    <div className="icon-service2 bg-success br-3">
                      <i className="fe fe-dollar-sign text-white fs-30" />
                    </div>
                  </div>
                </div>
                <div className="ml-auto text-right">
                  <p className="text-muted mb-1">Total Profits</p>
                  <h2 className="mt-2 mb-0 number-font">$54,890</h2>
                </div>
              </div>
            </div>
            <div className="card-footer">
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex">
                <div className="">
                  <div className="feature">
                    <div className="icon-service2 bg-warning br-3">
                      <i className="fe fe-shopping-cart text-white fs-30" />
                    </div>
                  </div>
                </div>
                <div className="ml-auto text-right">
                  <p className="text-muted mb-1">Total Orders</p>
                  <h2 className="mt-2 mb-0 number-font">78,965</h2>
                </div>
              </div>
            </div>
            <div className="card-footer">
              ...
              <div className="row">
                <div className="col-sm-12 col-md-12 col-lg-12 col-xl-8">
                  <div className="mb-5 mb-xl-0">
                    ...
                    <canvas
                      ...
                      style={{ display: "block", width: 651, height: 272 }}
                      width={651}
                      height={272}
                    />
                  </div>
                ...
                <div className="col-sm-12 col-md-12 col-lg-12 col-xl-4">
                  <div className="row pt-0">
                    <div className="card card-img-holder box-shadow-0 border p-0 mb-3">
                      <div className="card-body p-3">
                        <div className="clearfix">
                          <div className="float-left">
                            <p className="text-muted mb-1">Total Purchase</p>
                            <h2 className="mb-0 text-dark mainvalue">$7,483</h2>
                          </div>
                          <div className="float-right text-right mt-2">
                            <span
                              className="pie"
                              data-peity='{ "fill": ["#12d093", "rgba(119, 119, 142, 0.2)"]}'
                              style={{ display: "none" }}
                            >
                              0.52/1.561
                            </span>
                            <svg className="peity" height={50} width={50}>
                              <path
                                d="M 25 0 A 25 25 0 0 1 46.667386863494265 37.47094008115171 L 25 25"
                                fill="#12d093"
                              />
                              <path
                                d="M 46.667386863494265 37.47094008115171 A 25 25 0 1 1 24.999999999999996 0 L 25 25"
                  ...
                  <div className="row pt-3 pt-sm-1 mt-2 mt-sm-0">
                    <div className="card card-img-holder box-shadow-0 border p-0 mb-3">
                      <div className="card-body p-3">
                        <div className="clearfix">
                          <div className="float-left">
                          ...
                          <div className="float-right text-right mt-2">
                            <span
                              className="pie"
                              data-peity='{ "fill": ["#fda008", "rgba(119, 119, 142, 0.2)"]}'
                              style={{ display: "none" }}
                            >
                              0.52/1.561
                            </span>
                  ...
                  <div className="row pt-3 pt-sm-1 mt-2 mt-sm-0">
                    <div className="card card-img-holder box-shadow-0 border p-0">
                      <div className="card-body p-3">
                        <div className="clearfix">
                          <div className="float-left">
                            <p className="text-muted mb-1">Total Profits</p>
                            <h2 className="mb-0 text-dark mainvalue">$4,774</h2>
                          </div>
                          <div className="float-right text-right mt-2">
                            <span
                              className="pie"
                              data-peity='{ "fill": ["#ff5964", "rgba(119, 119, 142, 0.2)"]}'
                              style={{ display: "none" }}
                            >
                              226/360
                            </span>
                            <svg className="peity" height={50} width={50}>
                              <path
                                d="M 25 0 A 25 25 0 1 1 7.016504991533726 42.36645926147494 L 25 25"
                                fill="#ff5964"
                              />
                              <path
                                d="M 7.016504991533726 42.36645926147494 A 25 25 0 0 1 24.999999999999996 0 L 25 25"
                                fill="rgba(119, 119, 142, 0.2)"
                              />
                            </svg>
                          </div>
      ...
      <div className="row">
          ...
          <div className="card overflow-hidden">
            ...
            <div className="card-body">
              <div className="mb-5">
                ...
                <canvas
                  id="cost"
                  className="h-220 chartjs-render-monitor"
                  style={{ display: "block", width: 280, height: 220 }}
                  width={280}
                  height={220}
                />
              </div>
              <div className="row">
                <div className="col-6">
                  <div className="d-flex">
                    <div className="w-2 h-2 brround bg-secondary mr-2 mt-1 mb-1" />
                    <p className="mb-1">Sales Cost</p>
                  </div>
                  <h3 className="">$48,593</h3>
                </div>
                <div className="col-6">
                  <div className="d-flex">
                    <div className="w-2 h-2 brround bg-primary mr-2 mt-1 mb-1" />
                    <p className="mb-1">Marketing Cost</p>
                  </div>
                  <h3 className="">$25,067</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-sm-12 col-md-12 col-lg-12 col-xl-4">
          <div className="card overflow-hidden">
            <div className="card-header">
              <div>
                <h3 className="card-title">Product Ratings</h3>
              </div>
              <div className="card-options">
                <a
                  href=""
            ...
            <div className="card-body">
              <div className="mb-5">
                <h5 className="mb-1 d-block">
                  ...
                  <span className="float-right fs-12">89%</span>
                </h5>
                <div className="progress progress-md mb-4 h-2">
              ...
              <div className="mb-5">
                <h5 className="mb-1 d-block">
                  ...
                  <span className="float-right fs-12">65%</span>
                </h5>
                <div className="progress progress-md mb-4 h-2">
                  <div className="progress-bar progress-bar-striped progress-bar-animated bg-secondary w-60" />
                </div>
              </div>
              <div className="mb-5">
                <h5 className="mb-1 d-block">
                  <span className="fs-14 text-warning">
                    ...
                    <i className="fa fa-star mr-2" />
                    <i className="fa fa-star mr-2" />
                    <i className="fa fa-star-o mr-2" />
                    <i className="fa fa-star-o" />
                  </span>
                  <span className="float-right fs-12">52%</span>
                </h5>
                <div className="progress progress-md mb-4 h-2">
                  <div className="progress-bar progress-bar-striped progress-bar-animated bg-success w-50" />
                </div>
              </div>
              <div className="mb-5">
                <h5 className="mb-1 d-block">
                  ...
                  <span className="float-right fs-12">43%</span>
                </h5>
                <div className="progress progress-md mb-4 h-2">
              ...
              <div className="mb-5">
                <h5 className="mb-1 d-block">
                  ...
                  <span className="float-right fs-12">32%</span>
                </h5>
                <div className="progress progress-md mb-4 h-2">
              ...
              <div className="mb-0">
                <h5 className="mb-1 d-block">
                  ...
                  <span className="float-right fs-12">10%</span>
                </h5>
                <div className="progress progress-md mb-0 h-2">
                  <div className="progress-bar progress-bar-striped progress-bar-animated bg-warning w-1" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card overflow-hidden">
            ...
            <div className="card-body p-0">
              <div className="list-group list-lg-group list-group-flush">
                <a
                  className="list-group-item list-group-item-action border-left-0 border-right-0"
                  href="#"
                >
                  <div className="media mt-0">
                    <img
                      className="avatar-lg rounded-circle mr-3"
                      src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/users/female/2.jpg"
                      alt="Image description"
                    />
                    <div className="media-body">
                      <div className="d-md-flex align-items-center">
                        <h4 className="mb-1">Lisa Marshall</h4>
                        <small className="text-muted ml-md-auto">
                          <i className="fe fe-calendar mr-1" /> 28 Oct 2019
                        </small>
                      </div>
                      <p className="mb-0"> Web Desiner via Facebook</p>
                    </div>
                  </div>
                </a>
                <a
                ...
                >
                  <div className="media mt-0">
                    <img
                      className="avatar-lg rounded-circle mr-3"
                      src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/users/male/2.jpg"
                      alt="Image description"
                    />
                    <div className="media-body">
                      <div className="d-md-flex align-items-center">
                        <h4 className="mb-1">John Chapman</h4>
                        <small className="text-muted ml-md-auto">
                          <i className="fe fe-calendar mr-1" /> 16 Oct 2019
                        </small>
                      </div>
                      <p className="mb-0">App Developer via Linkedlin</p>
                    </div>
                  </div>
                </a>
                <a
                ...
                >
                  <div className="media mt-0">
                    <img
                      className="avatar-lg rounded-circle mr-3"
                      src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/users/male/8.jpg"
                      alt="Image description"
                    />
                    <div className="media-body">
                      <div className="d-md-flex align-items-center">
                        <h4 className="mb-1">Joseph Abraham</h4>
                        <small className="text-muted ml-md-auto">
                          <i className="fe fe-calendar mr-1" /> 26 Oct 2019
                        </small>
                      </div>
                      <p className="mb-0">Project Manager via Dribble</p>
                    </div>
                  </div>
                </a>
                <a
                ...
                >
                  <div className="media mt-0">
                    <img
                      className="avatar-lg rounded-circle mr-3"
                      src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/users/female/10.jpg"
                      alt="Image description"
                    />
                    <div className="media-body">
                      <div className="d-md-flex align-items-center">
                        <h4 className="mb-1">Sonia Smith</h4>
                        <small className="text-muted ml-md-auto">
                          <i className="fe fe-calendar mr-1" /> 05 Oct 2019
                        </small>
                      </div>
                      <p className="mb-0">FrontEnd Developer via Gmail</p>
                    </div>
                  </div>
                </a>
                <a
                ...
                >
                  <div className="media mt-0">
                    <img
                      className="avatar-lg rounded-circle mr-3"
                      src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/users/female/5.jpg"
                      alt="Image description"
                    />
                    <div className="media-body">
                      <div className="d-md-flex align-items-center">
                        <h4 className="mb-1">Ruth Robertson</h4>
                        <small className="text-muted ml-md-auto">
                          <i className="fe fe-calendar mr-1" /> 12 Oct 2019
                        </small>
                      </div>
                      <p className="mb-0">Sale Manger via Instagram</p>
                    </div>
                  </div>
                </a>
              </div>
      ...
      <div className="row">
        <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div className="card overflow-hidden">
            <div className="card-header">
              <div>
                <h3 className="card-title">Country Wise Sales</h3>
              </div>
              <div className="card-options">
                <a
                  href=""
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-xl-5 col-md-12">
                  <div id="world-map-markers" className="worldh h-250">
                    <div
                      className="jvectormap-container"
                      style={{ backgroundColor: "transparent" }}
                    >
                      <svg width="398.078" height={250}>
                        <defs />
                        <g transform="scale(0.44230888888888886) translate(0, 62.25477573691219)">
                          <path
                        ...
                        <g>
                          <circle
                            data-index={0}
                            cx="199.98041992852015"
                            cy="104.2409567122359"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={1}
                            cx="194.39835197263528"
                            cy="101.78874054466249"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={2}
                            cx="371.0752329890543"
                            cy="154.12236358281385"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={3}
                            cx="384.6759858656944"
                            cy="162.99396565629644"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={4}
                            cx="199.99149546017864"
                            cy="101.5181139816485"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={5}
                            cx="196.73528915257913"
                            cy="97.09871148170474"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={6}
                            cx="375.64942756401547"
                            cy="145.65876119213613"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={7}
                            cx="116.71457291990443"
                            cy="134.19666462143084"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={8}
                            cx="267.28642581723494"
                            cy="150.00108092829305"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={9}
                            cx="202.25090391851296"
                            cy="112.0325781702253"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={10}
                            cx="117.79997502243758"
                            cy="140.13699947140995"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={11}
                            cx="118.37590266867966"
                            cy="138.88831280424233"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={13}
                            cx="117.68921970585254"
                            cy="134.41332131360306"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={14}
                            cx="247.60520606007742"
                            cy="158.6557803717019"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={15}
                            cx="335.11298169389926"
                            cy="145.39158809787054"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={16}
                            cx="187.86378829411927"
                            cy="103.44163333791671"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={17}
                            cx="118.65279096014221"
                            cy="137.92969303994988"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={18}
                            cx="361.38414278786536"
                            cy="145.88133719971552"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={19}
                            cx="301.15540162893313"
                            cy="152.1065326904233"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={20}
                            cx="377.83130730074026"
                            cy="151.92929124558228"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={21}
                            cx="390.8672080627968"
                            cy="177.29611451227407"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={22}
                            cx="118.20976969380213"
                            cy="136.4704861862283"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={23}
                            cx="249.8756900500703"
                            cy="176.22166483947524"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={24}
                            cx="242.1781955474116"
                            cy="124.07216885303599"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                          ...
                          <circle
                            data-index={25}
                            cx="193.64521581985716"
                            cy="153.18093703840768"
                            fill="#5964ff   "
                            stroke="#fff"
                            fillOpacity="0.9"
                            strokeWidth={9}
                    ...
                    <table className="table border table-bordered text-nowrap mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <img
                              src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/flags/us.svg"
                          ...
                          <td>
                            44K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            55K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            41K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            37K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            22K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            43K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <img
                              src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/flags/in.svg"
                              className="w-5 h-5 mr-2"
                              alt=""
                            />
                            India
                          ...
                          <td>
                            53K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            32K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            33K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            52K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            13K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            43K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                        ...
                        <tr>
                          <td>
                            <img
                              src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/flags/ru.svg"
                              className="w-5 h-5 mr-2"
                              alt=""
                            />
                            Russia
                          ...
                          <td>
                            12K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            17K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            11K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            9K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            15K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            11K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                        ...
                        <tr>
                          <td>
                            <img
                              src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/flags/ca.svg"
                              className="w-5 h-5 mr-2"
                              alt=""
                            />
                            Canada
                          ...
                          <td>
                            7K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            5K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            8K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            6K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            9K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                        ...
                        <tr>
                          <td>
                            <img
                              src="https://laravel.spruko.com/indoui/Leftmenu-Icon-DarkSidebar-ltr/assets/images/flags/ge.svg"
                              className="w-5 h-5 mr-2"
                              alt=""
                            />
                            Germany
                          ...
                          <td>
                            25K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            12K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            19K <i className="fe fe-arrow-down text-danger" />{" "}
                          </td>
                          <td>
                            32K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            25K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                          <td>
                            24K <i className="fe fe-arrow-up text-success" />{" "}
                          </td>
                        </tr>{" "}
                      </tbody>
                    </table>{" "}
      ...
      <div className="row">
        <div className="col-sm-4 col-md-12 col-lg-4 col-xl-4">
          <div className="card">
            <div className="card-body text-center">
              <p className="mt-3 ml-3 mb-0">Total Profits</p>
              <h2 className="number-font mb-2 mt-2">$15,2654</h2>
              <p>
                <span className="text-success">
                  <i className="fa fa-arrow-up text-success" /> 16%
                </span>{" "}
                this Week
              </p>
              <div className="d-flex">
                <div className="w-5 h-5 bg-primary mr-4 br-3" />
                <div className="w-5 h-5 bg-primary mr-4 br-3" />
                <div className="w-5 h-5 bg-primary mr-4 br-3" />
                <div className="w-5 h-5 bg-primary mr-4 br-3" />
                <div className="w-5 h-5 bg-light mr-4 br-3" />
                <div className="w-5 h-5 bg-light mr-4 br-3" />
                <div className="w-5 h-5 bg-light mr-4 br-3" />
                <div className="w-5 h-5 bg-light br-3" />
              </div>
              <p className="mb-0 mt-2">
                <span className="float-left">Oct 01</span>{" "}
                <span className="float-right">Oct 31</span>
              </p>
            </div>
          </div>
        </div>
        <div className="col-sm-4 col-md-12 col-lg-4 col-xl-4">
          <div className="card">
            <div className="card-body text-center">
              <p className="mt-3 ml-3 mb-0">Total Sales</p>
              <h2 className="number-font mb-2 mt-2">23,2654</h2>
              <p>
                <span className="text-danger">
                  <i className="fa fa-arrow-down text-danger" /> 19%
                </span>{" "}
                this Week
              </p>
              <div className="d-flex">
                <div className="w-5 h-5 bg-secondary mr-4 br-3" />
                <div className="w-5 h-5 bg-secondary mr-4 br-3" />
                <div className="w-5 h-5 bg-secondary mr-4 br-3" />
                <div className="w-5 h-5 bg-light mr-4 br-3" />
                <div className="w-5 h-5 bg-light mr-4 br-3" />
        ...
        <div className="col-sm-4 col-md-12 col-lg-4 col-xl-4">
          <div className="card">
            <div className="card-body text-center">
              <p className="mt-3 ml-3 mb-0">Total Orders</p>
              <h2 className="number-font mb-2 mt-2">56,897</h2>
              <p>
                <span className="text-success">
                  <i className="fa fa-arrow-up text-success" /> 12%
                </span>{" "}
                this Week
              </p>
              <div className="d-flex">
                <div className="w-5 h-5 bg-success mr-4 br-3" />
                <div className="w-5 h-5 bg-success mr-4 br-3" />
                <div className="w-5 h-5 bg-success mr-4 br-3" />
                <div className="w-5 h-5 bg-success mr-4 br-3" />
                <div className="w-5 h-5 bg-success mr-4 br-3" />
